import { getSigningClient } from './wallet'
...
export async function getCodeMetadata (code_id: string, chain: Chain) {
  console.log('Loading wallet...')
  const { accounts, signingClient } = await getSigningClient(chain)
